    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            data.forEach(element => {
                for (var i = 1; i < 5; i++) {
                    suma += Math.sqrt(Math.pow(element[i] - ej1[i], 2));
                }
                resultados.push({
                    index: contador,
                    valor: suma,
            ...
            document.final.ESTILOFINAL.value = resultados[0].estilo;
...
function arreglarRegistro() {
    $.ajax({
        ...
        success: function(response) {
             ...
             * Registro incompleto
             */
            var ej1 = ['M', 'Turrialba', -100, 18, 14, 17, 18, 'asimilador'];
            ...
            resultados.sort(((a, b) => a.valor - b.valor));
            ej1[2] = resultados[0].promedio;
            let param = {
                'data': ej1
            };
            $.ajax({
                data: param,
                url: '?controller=Home&action=insertDataEj2',
                type: 'post',
                success: function(response) {
 ...
 * Registro a arreglar
 * 
 * M,Turrialba,,18,14,17,18,4,-1,asimilador
 */